...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Quit xmonad
    , ((modm .|. shiftMask,        xK_b     ), io (exitWith ExitSuccess))
...
myStartupHook = do
    spawnOnce "feh --bg-scale ~/background.png"
    spawnOnce "picom -b --experimental-backends --config ~/picom/picom.conf"
    setWMName "LG3D"
